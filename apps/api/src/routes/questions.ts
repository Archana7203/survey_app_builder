...
// GET /api/questions/types - Return available question types and their schemas
router.get('/types', (req, res) => {
  const questionTypes = [
    ...
    },
    {
      ...
      schema: {
        settings: {
          maxRating: { type: 'number', default: 10, min: 5, max: 20 },
        },
      },
    },
    {
    ...
    },
    {
      ...
      schema: {
        settings: {
          placeholder: { type: 'string' },
          maxLength: { type: 'number', max: 5000 },
          minLength: { type: 'number', min: 0 },
        },
      },
    },
    ...
    },
    {
      ...
      schema: {
        settings: {
          maxFileSize: { type: 'number', default: 10485760, max: 52428800 }, // 10MB default, 50MB max
